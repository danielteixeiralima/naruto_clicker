const heroesData = [
    { id: 1, name: "Naruto Uzumaki", baseCost: 10, baseDps: 1, img: "./static/img/naruto_face.png", focus: "center center" },
    { id: 2, name: "Sasuke Uchiha", baseCost: 100, baseDps: 5, img: "./static/img/sasuke_face.png", focus: "center center" },
    { id: 3, name: "Sakura Haruno", baseCost: 500, baseDps: 12, img: "./static/img/sakura_face.png", focus: "center center" },
    { id: 4, name: "Kiba Inuzuka", baseCost: 1000, baseDps: 25, img: "./static/img/heroes/icons/kiba_icon.png" },
    { id: 5, name: "Shino Aburame", baseCost: 2500, baseDps: 50, img: "./static/img/heroes/icons/shino_icon.png" },
    { id: 6, name: "Hinata Hyuga", baseCost: 5000, baseDps: 80, img: "./static/img/heroes/icons/hinata_icon.png" },
    { id: 7, name: "Shikamaru Nara", baseCost: 12000, baseDps: 150, img: "./static/img/heroes/icons/shikamaru_icon.png" },
    { id: 8, name: "Choji Akimichi", baseCost: 25000, baseDps: 300, img: "./static/img/heroes/icons/chouji_icon.png" },
    { id: 9, name: "Ino Yamanaka", baseCost: 60000, baseDps: 550, img: "./static/img/heroes/icons/ino_icon.png" },
    { id: 10, name: "Neji Hyuga", baseCost: 150000, baseDps: 1000, img: "./static/img/heroes/icons/neji_icon.png" },
    { id: 11, name: "Rock Lee", baseCost: 400000, baseDps: 2200, img: "./static/img/heroes/icons/rocklee_icon.png" },
    { id: 12, name: "Tenten", baseCost: 1000000, baseDps: 4500, img: "./static/img/heroes/icons/tenten_icon.png" },
    { id: 13, name: "Gaara", baseCost: 2500000, baseDps: 9000, img: "https://placehold.co/100x100/8b0000/ffffff?text=Gaara" },
    { id: 14, name: "Temari", baseCost: 6000000, baseDps: 18000, img: "https://placehold.co/100x100/f5deb3/000000?text=Temari" },
    { id: 15, name: "Kankuro", baseCost: 15000000, baseDps: 40000, img: "https://placehold.co/100x100/000000/ffffff?text=Kankuro" },
